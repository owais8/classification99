...
$sql4 = "SELECT COUNT(*) as total_files
        FROM uploaded_files";
          ...
          <div class="mt-2 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="overflow-hidden rounded-lg bg-white shadow">
                ...
                <div class="flex items-center">
                  ...
                  <div class="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      <dd>
                        <div class="text-lg font-medium text-gray-900"><?php echo $row4['total_files']?></div>
                      </dd>
                    </dl>
                  </div>
                </div>
              ...
              <div class="bg-gray-50 px-5 py-3">
                <div class="text-sm">
                  <a href="files.php" class="font-medium text-cyan-700 hover:text-cyan-900">View all</a>
                </div>
              </div>
            </div>
            <div class="overflow-hidden rounded-lg bg-white shadow">
              ...
              <div class="bg-gray-50 px-5 py-3">
                <div class="text-sm">
                  <a href="paid.php" class="font-medium text-cyan-700 hover:text-cyan-900">View all</a>
                </div>
              </div>
            </div>
            <div class="overflow-hidden rounded-lg bg-white shadow">
              ...
              <div class="bg-gray-50 px-5 py-3">
                <div class="text-sm">
                  <a href="all_users.php" class="font-medium text-cyan-700 hover:text-cyan-900">View all</a>
                </div>
              </div>
            </div>
